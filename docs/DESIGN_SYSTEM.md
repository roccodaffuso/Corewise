...
- Settings should use a native macOS Settings scene: compact, form-based, tabbed or sectioned, and visually quieter than diagnostic pages. Do not add Settings as another source-list item in the main diagnostic sidebar.
