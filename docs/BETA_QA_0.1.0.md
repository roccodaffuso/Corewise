...
- GitHub Actions run [29398616757](https://github.com/roccodaffuso/Corewise/actions/runs/29398616757) validated the exact Draft Release asset and checksum on both `macos-26` ARM64 and `macos-26-intel`.

### Physical Mac validation

The exact notarized DMG was mounted and copied to `/Applications/Corewise.app` on the primary Apple Silicon Mac.
