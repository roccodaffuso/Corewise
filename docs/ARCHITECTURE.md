...
4. The collector combines live performance signals with mock diagnostic coverage.
...
- Add a `DataMode` or equivalent enum to the model so UI badges do not depend on parsing source text.
