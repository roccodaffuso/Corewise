...
- The `0.1.0 (3)` beta.2 candidate was accepted by Apple under submission `52df1d9c-5ca7-40f5-8f29-82c800a1f687`; stapling, Gatekeeper, signature, notice, metadata, and checksum verification pass. SHA-256: `00444d9577db1b4708ab9ae6aa7a50bb55340b30bd5d978df2187ecb4d184389`.
...
- GitHub Actions run `29404942676` validated the exact beta.2 Draft Release DMG on clean ARM64 and Intel runners. Primary-Mac beta.2 QA passes installation, Gatekeeper, Quick Actions keyboard focus/routing, AI Workloads, and overlay dismissal; the broader beta.1 visual/Storage QA remains valid for unchanged code paths.
